...
class DeveloperPreview {
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$123.5Bn", percentageChange: 22.07)
    let state2 = StatisticModel(title: "Total volumn", value: "$223.5Tr")
    let state3 = StatisticModel(title: "Portfolio Value", value: "$632.5K", percentageChange: -22.02)
